 ...
 *
 * @desc
 * 		Plays the adventurer card.  It draws from the player's deck until two treasure
...
{
	/*
	 * moved these declarations from cardEffect() into here.  TODO: omit them from cardEffect() once
	 * all cards have been refactored accordingly.
	 */
	int 	drawntreasure=0;
	int 	cardDrawn;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	/* 
	 * TODO: 	once all the individual effects are refactored into their own functions, omit these 
	 * 			delecrations in the chunk of code below.
	 */
	int drawntreasure=0;	
	int cardDrawn;
